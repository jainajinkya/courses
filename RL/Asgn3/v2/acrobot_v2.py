...
#            else: action = 1
    ...
    def sarsa(self,n_eps,init_state,world,basis):
        ...
        for ep in range (n_eps):
            ...
            while(tip[1] < world.l1):
                ...
                self.weights[action+1,:] = self.weights[action+1,:] + delta*np.dot(self.alpha2,phi)
...
if __name__ == '__main__':
    ...
    t_n_steps  = algo.sarsa(n_eps,initState,world,basis)
